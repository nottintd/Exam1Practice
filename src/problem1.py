...
def run_test_problem1a():
    ...
    #Test 3:
    expected = -0.452  # This is APPROXIMATELY the correct answer.
    answer = problem1a(40, 80)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -1.907  # This is APPROXIMATELY the correct answer.
    answer = problem1a(100, 120)
    print()
...
def run_test_problem1b():
    ...
    # Test 2:
    expected = 26  # This is APPROXIMATELY the correct answer.
    answer = problem1b(10, 12)
    print()
